# Support for Output Descriptors in NaCacoin Core

Since NaCacoin Core v0.17, there is support for Output Descriptors in the
...
on NaCacoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing NaCacoin Core wallets, a convenience function `combo` is
