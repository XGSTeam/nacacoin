...
* nacacoin.conf: contains configuration settings for nacacoind or nacacoin-qt
* nacacoind.pid: stores the process id of nacacoind while running
...
* debug.log: contains debug information and general logging generated by nacacoind or nacacoin-qt
