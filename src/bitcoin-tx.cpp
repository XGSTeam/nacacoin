...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " nacacoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  nacacoin-tx [options] <hex-tx> [commands]  Update hex-encoded nacacoin transaction\n" +
            "or:     nacacoin-tx [options] -create [commands]   Create hex-encoded nacacoin transaction\n" +
            "\n";
