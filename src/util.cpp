...
const char * const BITCOIN_CONF_FILENAME = "nacacoin.conf";
const char * const BITCOIN_PID_FILENAME = "nacacoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "NaCacoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/NaCacoin";
#else
    // Unix
    return pathRet / ".nacacoin";
#endif
#endif
}
