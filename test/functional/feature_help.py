...
"""Verify that starting nacacoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nacacoin with -h for help text")
        ...
        self.log.info("Start nacacoin with -version for version information")
        ...
        self.log.info("Start nacacoind with -fakearg to make sure it does not start")
